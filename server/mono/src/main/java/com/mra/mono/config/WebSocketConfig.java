...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint("/ws")
                .setAllowedOrigins("http://localhost:3000","http://localhost:3001","http://localhost:5173","http://management.philofoody.com","http://branch.philofoody.com") // React uygulamasının URL'sini buraya ekleyin
