    ...
    return (
        <div className="sm:container mx-auto ">
            <div className="lg:flex">
                <div className="xl:w-2/5 lg:w-2/5 bg-dynamic py-16 xl:rounded-bl h-full xl:rounded-tr-none">
                ...
                <div className="xl:w-3/5 lg:w-3/5 bg-gray-200  h-fit pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
                    <form id="contact" className="bg-white py-4 px-8 rounded-tr rounded-br flex-row justify-center items-center">
